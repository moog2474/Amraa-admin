        ...
        if (e.changes && e.changes.length !== 0) {
            ...
            if (e.changes[0].type === "update") {
                try {
                    ...
                    await refService.editRefDepartment(e.changes[0].data);
                    //await getList();
                ...
                try {
                    ...
                    await refService.addRefDepartment(e.changes[0].data);
                    //await getList();
                ...
                try {
                    await refService.removeRefDepartment(e.changes[0].key);
                    //await getList();
