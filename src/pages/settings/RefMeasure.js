...
function RefMeasure(props) {
    ...
    const getList = async () => {
        try {
            setLoader(true);
            const result = await refService.getRefMeasure();
        ...
        if (e.changes && e.changes.length !== 0) {
            ...
            if (e.changes[0].type === "update") {
                try {
                    ...
                    await refService.editRefMeasure(e.changes[0].data);
                    //await getList();
                ...
                try {
                    ...
                    await refService.addRefMeasure(e.changes[0].data);
                    //await getList();
                ...
                try {
                    await refService.removeRefMeasure(e.changes[0].key);
                    //await getList();
                    ...
                    >
                        ...
                        <Editing
                            ...
                            texts={{
                                ...
                                confirmDeleteMessage: 'Энэ хэмжих нэгжийн мэдээллийг устгах уу?',
